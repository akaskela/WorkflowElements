...
{
    public class NumericManipulator
    {
        ...
        public decimal RoundToSignificantDigits(decimal input, int places)
        {
            return decimal.Parse(ToString((double)input, places));
        }
        ...
        public decimal RoundToDecimalPlaces(decimal input, int places)
        {
            return decimal.Parse(RoundToDecimalPlaces(input.ToString(), places));
        }
    ...
    public class Precision
    {
        ...
        public bool AlmostEquals(double a, double b, double epsilon = DOUBLE_EPSILON)
        {
